	...
	I created a runnable.jar (Backup Service Project) in the main directory of the project.	To run it you just need to do in command line:
	
	java -jar BackupServiceProject.jar (arguments here)
